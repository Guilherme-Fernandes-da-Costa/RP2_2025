...
print("\n=== Fator Ranking (primeiras linhas) ===")
print(df[['Fator_Ranking']].head())

# =============================
# 11. Salvar resultado final
# =============================
df.to_csv("dataset_m_fatorial_ranking.csv", index=False)
...
print("\n=== Classificação Fatorial (Primeiras linhas) ===")
print(df[["Fator_Ranking", "Classificação_Fatorial"]].head())
