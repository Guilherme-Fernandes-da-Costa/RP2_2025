...
dengue = pd.read_csv("dataset_dengue.csv")
populacao = pd.read_csv("dataset_sp_mun_população.csv")
...
dados_pop.to_csv("resultados/dataset_dados_unidos.csv", index=False)
...
dados_num[cols_saneamento_idx].to_csv(
    "resultados/dataset_normalizado_saneamento_idx.csv",
    index=False
)
...
dados_num[cols_s].to_csv(
    "resultados/dataset_normalizado_saneamento_completo.csv",
    index=False
)
...
# Salvar em CSV
correlacao_dengue.to_csv("resultados/dataset_correlacao.csv", header=["Correlacao"])
...
plt.tight_layout()
plt.savefig("resultados/img_correlacao_saneamento_dengue.png", dpi=300)
plt.close()
...
df_reg.to_csv("resultados/dataset_regressao_simples.csv", index=False)
...
dados_pop.to_csv('resultados/dataset_dados_unidos_estado.csv', index=False)  
...
plt.ylabel("Variável")
plt.tight_layout()
plt.savefig("resultados/img_top_10_correlacoes.png", dpi=300)
plt.close()
...
plt.savefig("resultados/img_regressao_multipla.png", dpi=300)
plt.close()
...
plt.tight_layout()
plt.savefig("resultados/img_Q-Q_plot.png", dpi=300)
plt.close()
...
plt.tight_layout()
plt.savefig("resultados/img_histograma_de_residuos.png", dpi=300)
plt.close()
